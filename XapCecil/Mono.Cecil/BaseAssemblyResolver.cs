...
namespace Mono.Cecil {
	...
	public class AssemblyResolutionException : FileNotFoundException {
		...
		public AssemblyResolutionException (AssemblyNameReference reference)
			: base (string.Format ("Failed to resolve assembly: '{0}'\nIf you are seeing this during debugging, you probably need to build the project before running UPL compiler", reference))
		{
			this.reference = reference;
		}
